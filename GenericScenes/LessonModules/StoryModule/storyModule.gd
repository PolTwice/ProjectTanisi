...
func _ready() -> void:
	...
	resource = get_parent().storyResource
...
func updateFromResource():
	creeLines = resource.creeLines
	englishLines = resource.englishLines
	creeAudios = resource.creeAudios
	englishAudios= resource.englishAudios
